...
def monitor_connection(n_pinged, address='8.8.8.8', retry_interval_sec_=retry_interval_sec, up_character_=up_character,
...
def monitor_server_router(n_pinged, router='192.168.0.1', server='8.8.8.8', retry_interval_sec_=retry_interval_sec,
